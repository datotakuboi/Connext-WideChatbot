...
def app():
    ...
    with chat_placeholder.container():
        ...
        for chat in st.session_state.chat_history:
            st.markdown(f'<div class="chat-message user-message">**You:** {chat["user_question"]}</div>', unsafe_allow_html=True)
            st.markdown(f'<div class="chat-message bot-message">**Bot:** {chat["response"]}</div>', unsafe_allow_html=True)
